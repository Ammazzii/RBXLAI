...
export default function HeroSignUpForm() {
  ...
  const handleEmailSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Simple front-end check for a valid email format
    if (!email.includes('@') || !email.includes('.')) {
      setError('Please enter a valid email address.');
      return;
    }

    // Redirect to the dashboard with the email as a URL parameter.
    // The dashboard page will handle the rest.
  ...
  return (
    <>
      ...
      {/* Link to dashboard for Google sign-in */}
